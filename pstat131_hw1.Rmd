...
**Answer:** First one is predictive, second is inferential
...
What i noticed through this histogram...
...
### Exercise 3
```{r}
barplot <- ggplot(mpg, aes(x=reorder(manufacturer, manufacturer, length))) + geom_bar()
barplot + coord_flip()

```
The manufacturer that produced the most cars is ... The manufacturer that produced the least cars is...
